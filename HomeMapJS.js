...
'<p>Attribution: My Brain, <a href="https://en.wikipedia.org/wiki/Brain">'+'https://en.wikipedia.org/wiki/Brain </a> '+ '<img src="Fisherfamily.jpg" alt="Fisher House" style="width:50%;height:50%">' +
'</div>';     
...
'<p>Attribution: Wekiva Springs State Park, <a href="https://en.wikipedia.org/wiki/Wekiwa_Springs_State_Park">'+
'https://en.wikipedia.org/wiki/Wekiwa_Springs_State_Park</a> '+ '<img src="https://media-cdn.tripadvisor.com/media/photo-s/0c/48/80/a4/wekiva-springs.jpg" alt="Apopka High School">' + '</div>';  
var contentString5 =
'<h1>Lake Apopka</h1>'+
...
'https://en.wikipedia.org/wiki/Lake_Apopka</a> '+ '<img src="https://www.orangeobserver.com/sites/default/files/LAKE-APOPKA-Lake-Apopka-sunset.jpg" alt="Lake Apopka" style="width:70%;height:70%">' + 
'</div>';
